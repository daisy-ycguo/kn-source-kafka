...
import (
	...
	pkgcore "github.com/maximilien/kn-source-pkg/pkg/core"
	"github.com/spf13/cobra"
)

// NewKnSourceKafkaCommand is to create a default kafka source command
func NewKnSourceKafkaCommand() *cobra.Command {
	...
	return pkgcore.NewKnSourceCommand(kafkaSourceFactory, kafkaCommandFactory, kafkaFlagsFactory, kafkaRunEFactory)
}
